---
layout: default
title: "The Instantiation Barrier Explained"
...
<div class="topic-header">
  <h1>The Instantiation Barrier Explained</h1>
...
- Round square (violates Identity: the same object can't be both all-corners and no-corners)
- Married bachelor (violates Non-Contradiction: can't have and lack the property "married")
- Object that neither exists nor doesn't exist (violates Excluded Middle)
- Detector that is both triggered and not-triggered in the same respect
