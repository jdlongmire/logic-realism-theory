...
<div class="topic-header">
  <h1>Wheeler's "It from Bit"</h1>
  <p>Grounding Information in Logical Admissibility</p>
</div>
...
<div class="paper-grid">
  <div class="paper-card">
    <h3><a href="{{ site.baseurl }}/papers/2026-it-from-bit/">It from Bit Paper</a></h3>
    <p>Full development of Wheeler grounding, the two domains, and fine-tuning thesis.</p>
  ...
  <div class="paper-card">
    ...
    <p>The $I_\infty$/$A_\Omega$ framework that grounds "it from bit."</p>
    <a href="{{ site.baseurl }}/papers/2026-position-paper/" class="card-link">Read Paper →</a>
  </div>

  <div class="paper-card">
    <h3><a href="{{ site.baseurl }}/papers/2025-gr-extension/">GR Extension</a></h3>
    <p>The bit scale, holographic connections, and identity strain.</p>
