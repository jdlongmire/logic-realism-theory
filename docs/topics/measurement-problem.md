...
<div class="topic-header">
  <h1>Measurement Problem</h1>
  <p>Structural vs. Mechanistic Explanation</p>
</div>
...
<div class="paper-grid">
  <div class="paper-card">
    ...
    <p>Measurement as vehicle-to-record transition; structural vs. mechanistic explanation.</p>
  ...
  <div class="paper-card">
    ...
    <p>Detailed dissolution of measurement, entanglement, and wave function puzzles.</p>
  ...
  <div class="paper-card">
    ...
    <p>Why probabilities have the form they do—derived, not postulated.</p>
