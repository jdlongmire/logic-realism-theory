...
<div class="topic-header">
  ...
  <p>Black Hole Information, Holographic Bounds, and Measurement</p>
</div>
...
$$\text{Id holds} \Rightarrow \text{No physical process destroys identity-constituting information}$$
...
<div class="paper-grid">
  <div class="paper-card">
    ...
    <p>Identity preservation, singularity constraints, and spacetime implications.</p>
  ...
  <div class="paper-card">
    ...
    <p>The bit-action conversion and holographic connections.</p>
  ...
  <div class="paper-card">
    ...
    <p>Core framework for extending $L_3$ constraints to spacetime.</p>
