...
### ACT-002: Actualized Domain AΩ

- **Role:** derived
- **Proof status:** verified
- **Epistemic status:** established
- **Depends on:** ONT-001, ACT-001
- **Lean artifacts:** 2 symbols

### EXT-001: Hardy Reconstruction Theorem
...
### ONT-003: Three Fundamental Logical Laws L₃
...
### PRD-001: Complex Over Real QM Prediction

- **Role:** prediction
- **Proof status:** prose_only
- **Epistemic status:** established
- **Depends on:** QM-003, EXT-001
...
### QM-005: Boolean Actualization

- **Role:** derived
- **Proof status:** verified
- **Epistemic status:** established
- **Depends on:** ONT-003, LOG-002
- **Lean artifacts:** 2 symbols
